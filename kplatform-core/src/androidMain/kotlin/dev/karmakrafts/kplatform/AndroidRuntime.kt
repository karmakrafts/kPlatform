...
// We don't support API level < 21, so we can hard-code against ART and ignore Dalvik
internal object AndroidRuntime : Runtime {
    override val type: RuntimeType = RuntimeType.ART
